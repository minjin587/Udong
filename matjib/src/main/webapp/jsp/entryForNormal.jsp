...
<body>
   ...
   <div class="store_container">
      <form action="../entry/entry.html" class="form" id="fileupload" name="form"
         enctype="multipart/form-data" method="post" onSubmit="return validate(this)">

         <div class="sidebar">
             <a class="active" href="#home">일반 회원 가입</a>
             <a href="../entry/managerlUser.html">기업 회원 가입</a>             
         </div>
         ...
         <div class="row">
            ...
            <div class="col-75">
             <input type="text" name="name" class="name" id="name" placeholder="이름을  입력하세요 ">
            </div>
         </div>
         ...
         <div class="row">
            ...
            <div class="col-75">
               ...
               name="user_id" placeholder="아이디를 입력해 주세요."><input type="hidden" name="idChecked" id="idChecked" /> <input
