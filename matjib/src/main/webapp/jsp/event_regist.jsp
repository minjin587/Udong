...
<body>
   <div class="store_container">
      <form action="../event/Addevent.html" method="post"
         enctype="multipart/form-data" id="fileupload" name="form">
<!-- 업체등록이 완료된 경우에는 첫페이지가 관리페이지로 가야함 -->
         <div class="sidebar">
            <a class="active" href="#home">이벤트 등록</a>
            <a href="../event/manage.html">이벤트 관리</a>                        
         </div>


         <div class="content">
			<input type="hidden" id="event_no">
            <div class="row">
               <div class="col-25">
                  <label for="evnet_name">이벤트 이름  </label>
               </div>
               <div class="col-75">
                  <input type="text" id="event_title" name="event_title"
                     placeholder="이벤트의 이름을 입력해주세요.">
               </div>
            </div>
